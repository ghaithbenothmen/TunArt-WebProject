...
use App\Entity\App\Repository\VoteRepository;
use App\Entity\Vote;
use App\Form\VoteType;
use App\Repository\VoteRepository as RepositoryVoteRepository;
...
class VoteController extends AbstractController
{
    ...
    public function index(RepositoryVoteRepository $voteRepository): Response
    {
    ...
    #[Route('/{idVote}', name: 'app_vote_show', methods: ['GET'])]
    ...
    #[Route('/{idVote}/edit', name: 'app_vote_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idVote}', name: 'app_vote_delete', methods: ['POST'])]
    public function delete(Request $request, Vote $vote, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$vote->getIdVote(), $request->request->get('_token'))) {
